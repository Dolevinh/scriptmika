...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Mika Hub chào ae<Color=/>"):Display()
    wait(.5)
    ...
    wait(.29)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Đăng ký kênh Vinh Modded để xem video mới nhất nhé<Color=/>"):Display()
    wait(.36)
end)

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "Mika Hub", HidePremium = false, IntroText = "Mika Hub⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("Đỗ Lê Vĩnh")
W:AddLabel("Discord Mika Hub")
local Section = W:AddSection({
    Name = "Status"
})
